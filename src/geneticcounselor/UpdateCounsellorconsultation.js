...
import {doCompleteCounsellorconsultation} from "./counsellorDispatcher";
...
function UpdateCounsellorconsultation() {

    const classes = useStyles();

    const history = useHistory();

    let {params} = useRouteMatch("/update-counsllorconsultation/:id");
    ...
    function handleSubmit(event) {
        ...
        doCompleteCounsellorconsultation(id,payload)
            .subscribe((response) => {
                appNotification.showSuccess("Succesfully Updated Counsellor Consultation")
               history.push("/counsllorconsultation-history")
                    ...
                    <Grid container spacing={2}  className={classes.formContainer} >
                        ...
                        <Grid item xs={6} >
                            <form className={classes.form} onSubmit={handleSubmit} noValidate>
                                    ...
                                    <Grid item xs={12} >
                                        ...
                                        <FormControl variant="outlined" className={classes.select100Form}>
                                            ...
                                            >
                                                ...
                                                <option value="NUTRITIONSREQUIRED">Nutritions Requrired</option>
                                                <option value="PHYSIOREQUIRED">Physio Recommented</option>
                                            </Select>
                                        </FormControl>
                                ...
                                >
                                    Update Counsellor Consultation
                                </Button>
...
export default UpdateCounsellorconsultation
