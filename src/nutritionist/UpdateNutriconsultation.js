...
import {doCompleteNutriconsultation} from "./nutritionDispatcher";
...
function UpdateNutriconsultation() {

    const classes = useStyles();

    const history = useHistory();

    let {params} = useRouteMatch("/update-nutriconsultation/:id");
    ...
    function handleSubmit(event) {
        ...
        doCompleteNutriconsultation(id,payload)
            .subscribe((response) => {
                appNotification.showSuccess("Succesfully Updated Nutrition Consultation")
               history.push("/nutriconsultation-history")
                                    ...
                                    <Grid item xs={12} >
                                        ...
                                        <FormControl variant="outlined" className={classes.select100Form}>
                                            ...
                                            >
                                                ...
                                                <option value="DITETION_REQUIRED">Physio Requrired</option>
                                                <option value="PHYSIOREQUIRED">Sports Medicine Recommented</option>
                                            </Select>
                                        </FormControl>
...
export default UpdateNutriconsultation
