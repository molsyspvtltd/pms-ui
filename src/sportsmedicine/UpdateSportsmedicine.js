...
import {doCompleteSportsmedicine} from "./sportsmedicineDispatcher";
...
function UpdateSportsmedicine() {

    const classes = useStyles();

    const history = useHistory();

    let {params} = useRouteMatch("/update-sportsmedicine/:id");
    ...
    function handleSubmit(event) {
        ...
        doCompleteSportsmedicine(id,payload)
            .subscribe((response) => {
                appNotification.showSuccess("Succesfully Updated Sports Medicine Consultation")
               history.push("/sportsmedicine-history")
                    ...
                    <Grid container spacing={2}  className={classes.formContainer} >
                        ...
                        <Grid item xs={6} >
                            <form className={classes.form} onSubmit={handleSubmit} noValidate>
                                    ...
                                    <Grid item xs={12} >
                                        ...
                                        <FormControl variant="outlined" className={classes.select100Form}>
                                            ...
                                            >
                                                ...
                                                <option value="PHYSIO_REQUIRED">PhysioTherapist Consultation Required</option>
                                                <option value="EXCERSISE">Do Excersise</option>
                                            </Select>
                                        </FormControl>
                                ...
                                >
                                    Update Sports Medicine Consultation
                                </Button>
...
export default UpdateSportsmedicine 
