...
import {doCompletePhysio} from "./physioDispatcher";
...
function UpdatePhysio() {

    const classes = useStyles();

    const history = useHistory();

    let {params} = useRouteMatch("/update-physio/:id");
    ...
    function handleSubmit(event) {
        ...
        doCompletePhysio(id,payload)
            .subscribe((response) => {
                appNotification.showSuccess("Succesfully Updated Physio Consultation")
               history.push("/physio-history")
                                    ...
                                    <Grid item xs={12} >
                                        ...
                                        <FormControl variant="outlined" className={classes.select100Form}>
                                            ...
                                            >
                                                ...
                                                <option value="DIET">Concentrate on diet</option>
                                                <option value="PHYSIO_REQUIRED">Physio Required</option>
                                            </Select>
                                        </FormControl>
