...
export const documentUploadUrl = environment.baseUrl + '/api/documents/upload/${id}/${role}';
...
export const doRegisterGeneticcounsiller = (registerRequest) => {

    const url = environment.baseUrl + '/auth/geneticcounsiler/register';

    return http.post(url, registerRequest);
}
export const doRegisterNutritionist = (registerRequest) => {

    const url = environment.baseUrl + '/auth/nutritionist/register';

    return http.post(url, registerRequest);
}
export const doRegisterSportsmedicine = (registerRequest) => {

    const url = environment.baseUrl + '/auth/sportsmedicine/register';

    return http.post(url, registerRequest);
}
export const doRegisterPhysiotherapist = (registerRequest) => {

    const url = environment.baseUrl + '/auth/physiotherapist/register';

    return http.post(url, registerRequest);
}
export const doRegisterLabteam = (registerRequest) => {

    const url = environment.baseUrl + '/auth/phalbotomist/register';
