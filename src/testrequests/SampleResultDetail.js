...
function SampleResultDetail({sampleResult}) {
    ...
    const {sampleId, comments, testTubeId, result, phalbotomist, updatedOn} = sampleResult
    const {firstName, lastName, email, phoneNumber} = phalbotomist
...
const {initials,name} = getNameAndInitials(firstName, lastName)
    ...
    return (<Card className={classes.root}>
            <CardHeader
                ...
                title={"Sample Collection Results"}
