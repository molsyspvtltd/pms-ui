...
import SampleResultDetail from "./SampleResultDetail";
...
function TestFlow(props) {
    ...
    if(testRequest.status !== "INITIATED" && testRequest.status !== "SAMPLE_COLLECTION_IN_PROGRESS" )
        sampleResult=testRequest.sampleResult;

    if(testRequest.status !== "SAMPLE_COLLECTED" && testRequest.status !== "LAB_TEST_IN_PROGRESS" )
    ...
    return (
        <React.Fragment>
            ...
            <Grid container spacing={2}  className={classes.formContainer} >
                ...
                {/*</Grid>*/}
                <Grid item xs={12} >
                    <SampleResultDetail sampleResult={sampleResult}></SampleResultDetail>
                </Grid>
                <Grid item xs={6} >
